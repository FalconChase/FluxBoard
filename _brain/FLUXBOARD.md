...
| —  | —        | Falcon to verify SES035-041 (speed-lock, multi-segment sketches, sketch style dropdown, curvature fix, port-pin/move-lock, true multi-segment paths, Move/Flip/Rotate/Group/Ungroup) end-to-end via `npm run tauri:dev`; then decide path-vs-node/path overlap + junctions, INSERT tab overlay, FBP012, FBP013, Milestone 6, or FBP015's design discussion. | — |
